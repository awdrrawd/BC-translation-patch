...
// 1) 字典
const { paths, activity, activityRegex, modRegex, bcxHelp, assetName, base, modMenu, stats } = generateDict();
const dictOut = path.join(repoRoot, "src", "generated", "dict.json");
ensureDir(dictOut);
fs.writeFileSync(dictOut, JSON.stringify({ paths, activity, activityRegex, modRegex, bcxHelp, assetName, base, modMenu }), "utf8");
